...
const slugToTitle: Record<string, string> = {
  ...
  'que-es-la-arteterapia-beneficios': '¿Qué es el arte como terapia?',
  'arteterapia-cancer': 'Arte como terapia y cáncer',
  'ejercicios-arteterapia': 'Ejercicios de arte como terapia',
  'beneficios-arte': 'Beneficios del arte',
  'mandalas-terapeuticos': 'Mandalas terapéuticos',
  'arte-trauma': 'Arte y trauma',
  'arteterapia-para-ninos': 'Arte como terapia para niños',
  'arteterapia-para-la-ansiedad': 'Arte como terapia para la ansiedad',
  'diferencia-psicologia-arteterapia': 'Diferencia psicología y arte como terapia',
  'arteterapia-y-autismo': 'Arte como terapia y autismo',
  'diferencia-arteterapia-clase-de-arte': 'Arte como terapia vs clase de arte',
