...
const tanatologiaArticles: Article[] = [
  ...
  { href: '/blog/duelos-invisibles-desautorizados', image: '/hombre-en-duelo.webp', alt: 'Duelos invisibles y pérdidas desautorizadas', title: 'Duelos invisibles: las pérdidas que nadie reconoce', description: 'Las pérdidas que la sociedad no valida pero que duelen igual.' },
]
