...
const tanatologiaArticles: Article[] = [
  ...
  { href: '/blog/bebe-arcoiris', image: '/bebe-arcoiris.jpg', alt: 'Bebé arcoíris', title: 'Bebé arcoíris', description: 'La luz que llega después de una pérdida gestacional.' },
  ...
  { href: '/blog/duelo-por-enfermedad-o-diagnostico', image: '/hombre-en-duelo.webp', alt: 'Duelo por enfermedad', title: 'Duelo por enfermedad o diagnóstico', description: 'El duelo que viene con un diagnóstico difícil.' },
  ...
  { href: '/blog/dia-del-padre-duelo', image: '/duelo-por-padre.jpeg', alt: 'Día del Padre en duelo', title: 'Día del Padre cuando tu papá ya no está', description: 'Para quienes viven el Día del Padre desde la pérdida o la relación complicada.' },
]
