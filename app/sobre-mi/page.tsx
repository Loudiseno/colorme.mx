    ...
    <article className="pt-28 pb-16 md:pt-36 md:pb-20">
      <div className="max-w-4xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="order-2 md:order-1">
              ...
              <p className="text-xl text-charcoal leading-relaxed">
                ...
                Mi camino personal de sanación me llevó a dedicar mi vida a acompañar a otros
        ...
        <section className="mb-16">
          <h2 className="font-display text-3xl text-ink mb-6">Mi historia</h2>
        ...
        {/* Formation Section */}
        <section className="mb-16">
          <h2 className="font-display text-3xl text-ink mb-6">Mi formación</h2>
          <div className="prose prose-lg max-w-none">
            <h3>Tanatología</h3>
            <p>
            ...
            <p>
              ...
              en la conexión entre el arte, la naturaleza y la sanación emocional en un entorno
              que honra las tradiciones ancestrales de bienestar.
            </p>

            <h3>Técnicas artísticas internacionales</h3>
            <p>
            ...
            <ul>
              ...
              <li><strong>Bali</strong> — Tradiciones artísticas balinesas y su conexión con la sanación</li>
            </ul>

            <h3>Prácticas espirituales y de bienestar</h3>
            <p>
              Complemento mi práctica terapéutica con técnicas de bienestar holístico:
            </p>
            <ul>
              <li><strong>Reiki</strong> — Certificada en India, esta práctica de sanación energética
        ...
        <section className="mb-16">
          <h2 className="font-display text-3xl text-ink mb-6">Mi trayectoria profesional</h2>
          <div className="prose prose-lg max-w-none">
            <p>
            ...
            <p>
              ...
              a otros en su propio proceso creativo de sanación.
            </p>
          </div>
        </section>

        {/* Book Section */}
        <section className="mb-16 p-8 bg-[#b2f7ef] rounded-2xl">
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div>
              <h2 className="font-display text-3xl text-ink mb-4">Indeleble</h2>
        ...
        <section className="text-center p-8 bg-white rounded-2xl border border-[#b2f7ef]">
          ...
          <p className="text-charcoal mb-8 max-w-xl mx-auto">
