    ...
    <article className="pt-28 pb-16 md:pt-36 md:pb-20">
      <div className="max-w-3xl mx-auto px-6">
        ...
        <div className="prose prose-lg max-w-none text-black/80">
          ...
          <p>
            Estas 12 claves no van a &quot;quitarte&quot; el dolor. Pero pueden darte herramientas concretas para los días difíciles, momentos de calma en medio de la tormenta, y una para cuando no sepas qué hacer con lo que sientes.
          </p>
