...
export const metadata: Metadata = {
  ...
  description: 'Todo sobre el proceso de duelo y pérdida. Aprende a transitar el dolor, identificar las etapas del duelo y cuándo buscar acompañamiento profesional.',
  ...
  openGraph: {
    ...
    description: 'Todo sobre el proceso de duelo y pérdida. Aprende a transitar el dolor y cuándo buscar acompañamiento profesional.',
