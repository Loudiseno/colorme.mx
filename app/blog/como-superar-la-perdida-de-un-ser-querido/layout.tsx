...
export const metadata: Metadata = {
  ...
  description: 'Orientación práctica para atravesar el duelo por la muerte de un ser querido. 12 claves que te ayudarán a transitar el dolor y encontrar momentos de paz.',
  ...
  openGraph: {
    type: 'article',
    title: 'Cómo superar la pérdida de un ser querido: 12 claves prácticas | ColorMe',
    description: 'Orientación práctica para atravesar el duelo por la muerte de un ser querido.',
