    ...
    <article className="pt-28 pb-6 md:pt-32 md:pb-8">
      <div className="max-w-3xl mx-auto px-6">
        ...
        <div className="prose prose-lg max-w-none text-black/80">
          ...
          <p>
            Mi formación como facilitadora de arte como terapia integra técnicas de distintas tradiciones: México, Bali, Tailandia, Malasia, India y Reino Unido. Eso significa que trabajo con una paleta muy amplia de recursos expresivos, adaptados a cada persona y a cada momento del proceso.
          </p>
