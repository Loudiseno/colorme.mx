    ...
    <article className="pt-28 pb-16 md:pt-36 md:pb-20">
      <div className="max-w-3xl mx-auto px-6">
        ...
        <div className="mb-12 rounded-2xl overflow-hidden">
          <Image src="/diferencia psicologia y arteterapia.jpeg" alt="Pinceles y materiales de arte sobre una mesa de terapia" width={1200} height={675} className="w-full h-auto" />
        </div>
