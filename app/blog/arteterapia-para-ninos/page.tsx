    ...
    <article className="pt-28 pb-6 md:pt-32 md:pb-8">
      <div className="max-w-3xl mx-auto px-6">
        ...
        <div className="prose prose-lg max-w-none text-black/80">
          ...
          <p>
            Puedes ofrecer actividades artísticas en casa que favorezcan la expresión emocional, pero la arteterapia requiere de un profesional formado que sepa acompañar el proceso. Las actividades en casa son un complemento, no un sustituto.
          </p>
