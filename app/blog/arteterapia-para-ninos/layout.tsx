...
export const metadata: Metadata = {
  title: 'Arteterapia para niños: por edades de 3 a 12 años | ColorMe',
  description: 'Descubre cómo la arteterapia ayuda a los niños a expresar emociones. Información completa por edades con actividades, beneficios y señales de que tu hijo podría beneficiarse.',
...
const articleSchema = {
  ...
  '@type': 'Article',
  headline: 'Arteterapia para niños: por edades de 3 a 12 años',
  description: 'Descubre cómo la arteterapia ayuda a los niños a expresar emociones. Información completa por edades con actividades, beneficios y señales de que tu hijo podría beneficiarse.',
