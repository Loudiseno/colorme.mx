    ...
    <article className="pt-28 pb-6 md:pt-32 md:pb-8">
      <div className="max-w-3xl mx-auto px-6">
        ...
        <header className="mb-8">
          ...
          <p className="text-black/60 italic">Por Lourdes Pérez | Tanatóloga, facilitadora de arte como terapia y Sobreviviente de Cáncer</p>
        </header>
        ...
        <div className="prose prose-lg max-w-none text-black/80">
          ...
          <p>
            Hoy, como sobreviviente, tanatóloga y facilitadora de arte como terapia, acompaño a otras personas que están transitando ese mismo camino. Y quiero compartir contigo lo que he aprendido -desde adentro y desde afuera- sobre cómo el arte puede ser un aliado en el proceso oncológico.
          </p>
          ...
          <h3 className="text-xl md:text-2xl text-black font-semibold mt-6 mb-3">Durante el tratamiento</h3>
          ...
          <h3 className="text-xl md:text-2xl text-black font-semibold mt-6 mb-3">Después del tratamiento</h3>
          ...
          <h3 className="text-xl md:text-2xl text-black font-semibold mt-6 mb-3">Para familiares y cuidadores</h3>
          ...
          <h2 className="text-2xl md:text-3xl text-black font-semibold mt-8 mb-4">Tanatología y arteterapia: un enfoque integral</h2>
