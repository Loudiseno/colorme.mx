    ...
    <article className="pt-28 pb-16 md:pt-36 md:pb-20">
      <div className="max-w-3xl mx-auto px-6">
        ...
        <div className="mb-12 rounded-2xl overflow-hidden">
          <Image src="/duelo en redes.jpeg" alt="Persona mirando el perfil digital de un ser querido fallecido en su teléfono" width={1200} height={675} className="w-full h-auto" />
        </div>
