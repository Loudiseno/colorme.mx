    ...
    <article className="pt-28 pb-16 md:pt-36 md:pb-20">
      <div className="max-w-3xl mx-auto px-6">
        ...
        <div className="prose prose-lg max-w-none text-black/80">
          ...
          <p>
            El <strong>tanatólogo</strong> es mucho más que un experto en temas relacionados con la muerte. Es un acompañante capacitado que nos acompaña a través del proceso de duelo, brindándonos herramientas para transformar el dolor en un camino hacia la sanación.
          </p>
