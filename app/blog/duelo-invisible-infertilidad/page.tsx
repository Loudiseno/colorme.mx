...
export default function DueloInvisibleInfertilidadPage() {
  return (
    <article className="pt-28 pb-6 md:pt-32 md:pb-8">
      <div className="max-w-3xl mx-auto px-6">
        ...
        <div className="mb-12 rounded-2xl overflow-hidden">
          <Image
            src="/duelo-invisible-infertilidad.jpeg"
            alt="El duelo invisible por infertilidad - cuando la maternidad o paternidad no llega"
            width={300}
            height={200}
            priority
        ...
        <div className="prose prose-lg max-w-none text-black/80">
          ...
          <p>
            <strong>"Relájate y ya vendrá."</strong> Como si el estrés fuera la causa de la infertilidad y relajarse la solución. Esta frase minimiza un problema médico real y pone la responsabilidad en quien ya está sufriendo.
          </p>

          <p>
            <strong>"Siempre puedes adoptar."</strong> La adopción es una opción valiosa para quienes la eligen conscientemente. Pero no es un reemplazo del duelo por la maternidad o paternidad biológica. Son procesos diferentes que no se cancelan entre sí.
          </p>

          <p>
            <strong>"Todo pasa por algo."</strong> Buscar un significado espiritual a un dolor que no tiene sentido no ayuda a quien lo está viviendo. A veces las cosas simplemente duelen y no hay un propósito oculto.
          </p>

          <p>
            <strong>"¿Y para cuándo el bebé?"</strong> Esta pregunta casual, tan común en reuniones familiares, puede ser devastadora para quien lleva años intentando o ya sabe que no podrá.
          </p>
          ...
          <p>
            <strong>Busca personas que entiendan.</strong> Grupos de apoyo para personas con infertilidad pueden ofrecer un espacio donde no tengas que explicar ni justificar tu dolor.
          </p>
          ...
          <p>
            <strong>Encuentra formas de expresión.</strong> El arte, la escritura, el movimiento pueden ser canales para procesar emociones que no caben en palabras.
          </p>
        ...
        <div className="mt-16 p-8 bg-[#B2F7EF]/10 rounded-2xl border border-[#B2F7EF] text-center">
          ...
          <p className="text-black/70 mb-6 max-w-xl mx-auto">
            Si estás cargando este dolor en silencio, hay un espacio donde puedes nombrarlo sin explicaciones.
          </p>
          <a
        ...
        <RelatedArticles currentSlug="duelo-invisible-infertilidad" category="tanatologia" />
      </div>
    </article>
  )
}
