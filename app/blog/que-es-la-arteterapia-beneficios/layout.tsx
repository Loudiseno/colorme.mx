...
export const metadata: Metadata = {
  title: '¿Qué es la Arteterapia? | Apoyo Completa',
  description: 'Descubre qué es la arteterapia, cómo funciona, sus beneficios y para quién es. Apoyo completa sobre terapia a través del arte para sanar emociones.',
  ...
  openGraph: {
    type: 'article',
    title: '¿Qué es la Arteterapia? | Apoyo Completa | ColorMe',
...
const articleSchema = {
  ...
  '@type': 'Article',
  headline: '¿Qué es la Arteterapia? Apoyo Completa',
  description: 'Descubre qué es la arteterapia, cómo funciona, sus beneficios y para quién es.',
