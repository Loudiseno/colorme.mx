...
export const metadata: Metadata = {
  ...
  description: 'Descubre qué es la arteterapia, cómo funciona, sus beneficios y para quién es. Información completa sobre terapia a través del arte para sanar emociones.',
...
const articleSchema = {
  ...
  '@type': 'Article',
  headline: '¿Qué es la Arteterapia? Información Completa',
  description: 'Descubre qué es la arteterapia, cómo funciona, sus beneficios y para quién es.',
