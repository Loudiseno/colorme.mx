    ...
    <article className="pt-28 pb-16 md:pt-36 md:pb-20">
      <div className="max-w-3xl mx-auto px-6">
        ...
        <div className="mb-12 rounded-2xl overflow-hidden">
          <Image src="/bebe arcoiris.jpg" alt="Bebé arcoíris" width={300} height={200} priority className="w-full h-auto" />
        </div>
        ...
        <div className="mt-16 p-8 bg-[#B2F7EF]/10 rounded-2xl border border-[#B2F7EF] text-center">
          <h3 className="text-2xl text-black mb-4 font-semibold">¿Estás viviendo la maternidad arcoíris?</h3>
          <p className="text-black/70 mb-6 max-w-xl mx-auto">En ColorMe ofrezco una sesión de orientación gratuita donde puedes hablar del bebé que perdiste y del bebé que llegó, y explorar si este espacio de acompañamiento tiene sentido para ti.</p>
