    ...
    <article className="pt-32 pb-16 md:pt-40 md:pb-20 bg-white">
      <div className="max-w-3xl mx-auto px-6">
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <p>El duelo perinatal es uno de los más silenciados y minimizados. Porque la sociedad no siempre sabe cómo hablar de bebés que mueren antes de vivir. Porque la gente no sabe qué decir, entonces a veces no dice nada. Porque te dicen frases que intentan consolar pero terminan lastimando.</p>

          <p>Este artículo es para ti. Para validar tu experiencia, reconocer tu dolor, y ofrecerte algunas herramientas para atravesar este proceso.</p>
          ...
          <p>A veces no hay funeral. No hay licencia de duelo. No hay las mismas muestras de apoyo que con otras pérdidas. El mundo puede seguir como si nada hubiera pasado.</p>

          <p>Mientras tanto, tu cuerpo sigue procesando el embarazo, y tú tienes que funcionar en medio del dolor.</p>
          ...
          <p><strong>Sensación de vacío físico.</strong> Tu cuerpo que estaba preparándose para otra cosa.</p>

          <p>Todas estas emociones pueden coexistir. Puedes sentir varias en el mismo día. El duelo perinatal es complejo.</p>

          <h2>Lo que tu pareja puede estar sintiendo</h2>

          <p>Si tienes pareja, es importante entender que ambos están en duelo, pero probablemente de maneras diferentes.</p>

          <p>La persona que estaba embarazada tiene el componente físico añadido. Tenía una conexión corporal con el bebé que la otra persona no tuvo de la misma manera.</p>

          <p>La pareja puede sentir impotencia, presión de &quot;ser fuerte&quot;, y su propio duelo que no siempre sabe cómo expresar.</p>

          <p>Las parejas procesan el duelo a ritmos diferentes. Esto puede crear tensión si no se habla abiertamente. Si sienten que no pueden comunicarse, buscar apoyo profesional juntos puede ayudar.</p>
          ...
          <p><em>&quot;Algo habrá estado mal, es lo mejor.&quot;</em> — No me digas que perder a mi bebé es &quot;lo mejor&quot;.</p>

          <p><em>&quot;Por algo pasan las cosas.&quot;</em> — No hay razón que haga esto menos doloroso.</p>

          <p><em>&quot;Ya deberías estar mejor.&quot;</em> — El duelo no tiene fecha límite.</p>

          <p>Si alguien te dice estas cosas, puedes establecer un límite gentil si lo necesitas.</p>

          <h2>Lo que sí puede ayudar</h2>

          <h3>Nombrar a tu bebé</h3>
          <p>Si quieres darle un nombre, hazlo. Tener un nombre hace que la pérdida sea más concreta. Ese nombre te da algo a qué aferrarte.</p>
          ...
          <p>Aunque no haya funeral tradicional, puedes crear tu propia forma de despedida: una ceremonia íntima, encender una vela en fechas significativas, visitar un lugar especial.</p>
          ...
          <p>Saber que no estás sola, que otros entienden de verdad, marca una diferencia.</p>
          ...
          <p>Busca un profesional con experiencia en duelo perinatal. No cualquier terapeuta entiende la especificidad de esta pérdida.</p>
          ...
          <p>Date tiempo para recuperarte físicamente. No te exijas volver a la normalidad rápidamente. Tu cuerpo también necesita procesar.</p>
          ...
          <ul>
            ...
            <li>Presión de &quot;seguir adelante&quot; por ellos.</li>
          </ul>

          <p>Los niños pueden participar en el duelo de maneras apropiadas para su edad si tú lo decides. Puedes explicarles lo que pasó en términos que puedan entender e incluirlos en rituales de recuerdo si lo deseas.</p>

          <p>Cuidarte a ti no significa descuidarlos. Pero no tienes que fingir que estás bien cuando no lo estás.</p>
          ...
          <ul>
            ...
            <li>Sensaciones difíciles sobre &quot;reemplazar&quot; al bebé perdido.</li>
            <li>Presión externa.</li>
            <li>Ansiedad ante la posibilidad de un nuevo embarazo.</li>
          </ul>

          <p>No hay respuesta correcta. Algunas personas quieren intentarlo pronto. Otras necesitan tiempo. Otras deciden no intentarlo más.</p>

          <p>Todas las opciones son válidas.</p>

          <p>Si decides intentar un nuevo embarazo, es normal que venga acompañado de ansiedad. Un embarazo después de pérdida tiene sus propios desafíos emocionales.</p>

          <h2>Cuándo buscar ayuda profesional</h2>

          <p>Considera buscar apoyo especializado si:</p>
          <ul>
            <li>Sientes que no puedes funcionar después de varias semanas.</li>
            <li>Tienes pensamientos de hacerte daño.</li>
            <li>No puedes dejar de culparte.</li>
            <li>El dolor no muestra ninguna mejoría.</li>
            <li>Estás usando sustancias para aliviar el dolor.</li>
            <li>Tu relación de pareja está en crisis.</li>
          </ul>
