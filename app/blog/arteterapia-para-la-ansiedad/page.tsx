      ...
      <div className="max-w-3xl mx-auto px-6">
        ...
        <header className="mb-8">
          ...
          <h1 className="text-3xl md:text-5xl text-black mt-3 mb-6 leading-tight font-semibold">
            Arte como terapia para la ansiedad: cómo el arte puede ayudarte
          </h1>
        ...
        <div className="mb-12 rounded-2xl overflow-hidden">
          <Image
            ...
            alt="Arte como terapia para la ansiedad - Expresión a través del arte"
            width={300}
            height={200}
            priority
        ...
        <div className="prose prose-lg max-w-none text-black/80">
          ...
          <p>
            Si vives con ansiedad, sabes que a veces las palabras no alcanzan para explicar lo que sientes. Esa opresión en el pecho, los pensamientos que no paran, la sensación de que algo malo va a pasar aunque no sepas qué. La <strong>arte como terapia para la ansiedad</strong> ofrece algo diferente: un camino donde no necesitas encontrar las palabras correctas, porque el color, la forma y el movimiento se convierten en tu lenguaje.
          </p>

          <p>
            En este artículo no voy a darte una lista de ejercicios para hacer en casa. Quiero explicarte cómo funciona el arte como terapia, qué sucede cuando creas en un espacio terapéutico y por qué puede ser una herramienta poderosa para ti.
          </p>

          <h2 className="text-2xl md:text-3xl text-black font-semibold mt-8 mb-4">Qué hace el arte como terapia con tu ansiedad</h2>

          <p>
            La ansiedad vive en el cuerpo tanto como en la mente. Esa tensión en los hombros, el estómago revuelto, la mandíbula apretada. El arte como terapia trabaja en ambos niveles porque crear arte involucra tu cuerpo y tu mente simultáneamente.
          </p>
          ...
          <p>
            El arte como terapia no es simplemente sentarte a pintar. Es un proceso acompañado por un profesional que sabe observar, contener y facilitar lo que surge mientras creas.
          </p>

          <h3 className="text-xl md:text-2xl text-black font-semibold mt-6 mb-3">El espacio seguro</h3>
          <p>
            Una de las claves del arte como terapia es el espacio que se construye. Un lugar donde puedes crear sin juicio, donde no hay &quot;bien&quot; o &quot;mal&quot;, donde lo que hagas tiene valor porque es tuyo. Para alguien con ansiedad, que frecuentemente se juzga y se exige, este espacio puede ser profundamente reparador.
          </p>
          ...
          <p>
            Esto es fundamental y vale la pena repetirlo: en arte como terapia, lo que importa es el proceso, no el producto final.
          </p>
          ...
          <h2 className="text-2xl md:text-3xl text-black font-semibold mt-8 mb-4">Lo que el arte como terapia puede darte</h2>
          ...
          <p>
            Lo que aprendes en arte como terapia -la capacidad de expresarte creativamente, de tolerar la incertidumbre, de soltar el control- son habilidades que puedes llevar a tu vida cotidiana. No desaparecen cuando termina la sesión.
          </p>

          <h3 className="text-xl md:text-2xl text-black font-semibold mt-6 mb-3">Un espacio que es solo tuyo</h3>
          <p>
            En un mundo donde probablemente pasas mucho tiempo atendiendo responsabilidades y expectativas de otros, el arte como terapia es un espacio dedicado exclusivamente a ti. A lo que sientes, a lo que necesitas, a lo que quieres expresar.
          </p>
          ...
          <p>El arte como terapia puede ser especialmente útil cuando:</p>
          <ul className="list-disc pl-6 space-y-2">
          ...
          <h2 className="text-2xl md:text-3xl text-black font-semibold mt-8 mb-4">Arte como terapia y otras formas de terapia</h2>

          <p>
            El arte como terapia no tiene que ser un camino solitario. Puede funcionar muy bien en combinación con otras formas de tratamiento.
          </p>

          <h3 className="text-xl md:text-2xl text-black font-semibold mt-6 mb-3">Como complemento de la terapia verbal</h3>
          <p>
            Muchas personas combinan sesiones de arte como terapia con psicoterapia tradicional. Lo que surge en la creación artística puede convertirse en material para explorar en la terapia verbal, y viceversa.
          </p>

          <h3 className="text-xl md:text-2xl text-black font-semibold mt-6 mb-3">Junto con tratamiento médico</h3>
          <p>
            Si tu ansiedad requiere medicación, el arte como terapia no la reemplaza. Pero puede ser un complemento valioso que trabaja aspectos que la medicación no aborda: la expresión emocional, el autoconocimiento, las estrategias de afrontamiento.
          </p>

          <h3 className="text-xl md:text-2xl text-black font-semibold mt-6 mb-3">Como parte de un enfoque integral</h3>
          <p>
            Ejercicio, meditación, alimentación, sueño, conexión social, terapia, arte como terapia: todos estos elementos pueden formar parte de un abordaje integral de la ansiedad. No hay una sola respuesta correcta.
          </p>

          <h2 className="text-2xl md:text-3xl text-black font-semibold mt-8 mb-4">Lo que no es arte como terapia</h2>

          <p>Para que tengas expectativas claras, es importante aclarar lo que el arte como terapia no es:</p>
          ...
          <p><strong>No es manualidades para relajarse.</strong> Aunque crear puede ser relajante, el arte como terapia va más allá. Implica un proceso acompañado de exploración emocional.</p>
          ...
          <p><strong>No requiere talento.</strong> Lo repito porque es importante: cualquier persona puede beneficiarse del arte como terapia, independientemente de su habilidad artística.</p>

          <h2 className="text-2xl md:text-3xl text-black font-semibold mt-8 mb-4">Preguntas frecuentes</h2>

          <h3 className="text-xl md:text-2xl text-black font-semibold mt-6 mb-3">¿El arte como terapia funciona para todo tipo de ansiedad?</h3>
          <p>
          ...
          <h3 className="text-xl md:text-2xl text-black font-semibold mt-6 mb-3">¿Puedo hacer arte como terapia si nunca he hecho arte en mi vida?</h3>
          <p>
          ...
          <p>
            No exactamente. Pintar en casa puede ser relajante y valioso, pero el arte como terapia incluye el acompañamiento de un profesional que sabe cómo facilitar el proceso, contener lo que surge y ayudarte a profundizar en la exploración.
          </p>
        ...
        <div className="mt-16 p-8 bg-[#B2F7EF]/10 rounded-2xl border border-[#B2F7EF] text-center">
          ...
          <p className="text-black/70 mb-6 max-w-xl mx-auto">
            Si sientes curiosidad por explorar el arte como terapia dentro de tu camino para manejar la ansiedad, puedo orientarte.
          </p>
          <a
