    ...
    <article className="pt-28 pb-16 md:pt-36 md:pb-20">
      <div className="max-w-3xl mx-auto px-6">
        ...
        <div className="mb-12 rounded-2xl overflow-hidden">
          <Image src="/duelo por divorcio.jpeg" alt="Persona mirando por la ventana en un momento de reflexión y duelo" width={1200} height={675} className="w-full h-auto" />
        </div>
        ...
        <div className="prose prose-lg max-w-none text-black/80">
          ...
          <h2 className="text-2xl md:text-3xl text-black font-semibold mt-8 mb-4">Por qué el duelo por divorcio es un duelo real</h2>
          ...
          <ul className="list-disc ml-6 space-y-2">
            <li>El futuro que habías imaginado juntos.</li>
            <li>La familia que habías construido o soñado construir.</li>
            <li>Un hogar, una rutina, una forma de vida.</li>
            <li>Tu identidad como "esposa/esposo" o como parte de una pareja.</li>
            <li>Las personas que venían con esa relación: suegros, cuñados, amigos en común.</li>
            <li>A veces, hasta una versión de ti misma que solo existía en ese vínculo.</li>
          </ul>
          ...
          <h2 className="text-2xl md:text-3xl text-black font-semibold mt-8 mb-4">Por qué la sociedad no valida este duelo</h2>
          ...
          <ul className="list-disc ml-6 space-y-2">
            <li>"Mejor que lo hayas dejado antes de que fuera peor."</li>
            <li>"Por lo menos no tienen hijos."</li>
            <li>"Ya te va a llegar alguien mejor."</li>
            <li>"¿Pero si tú lo querías, no?"</li>
            <li>"Hay gente con problemas peores."</li>
          </ul>
          ...
          <h3 className="text-xl md:text-2xl text-black font-semibold mt-6 mb-3">Enojo</h3>
          <p>
          ...
          <h3 className="text-xl md:text-2xl text-black font-semibold mt-6 mb-3">Negociación y culpa</h3>
          <p>
          ...
          <h3 className="text-xl md:text-2xl text-black font-semibold mt-6 mb-3">Tristeza y depresión</h3>
          <p>
          ...
          <h3 className="text-xl md:text-2xl text-black font-semibold mt-6 mb-3">Aceptación e integración</h3>
          <p>
          ...
          <h2 className="text-2xl md:text-3xl text-black font-semibold mt-8 mb-4">La pérdida de identidad: quién eres cuando dejas de ser "nosotros"</h2>
          ...
          <p>
            <strong>Permítete sentir lo que sientes, sin juicio.</strong> El duelo no es lineal ni ordenado. Puedes sentir alivio un día y devastación al siguiente. Puedes reírte de un recuerdo y llorar de inmediato. Todo eso es parte del proceso. No te exijas "estar bien" antes de tiempo.
          </p>

          <p>
            <strong>Busca espacios seguros para expresarte.</strong> Ya sea con una amiga de confianza, en un diario, en sesiones de terapia o a través del arte. El duelo necesita ser expresado para poder moverse. Guardarlo o suprimirlo solo lo prolonga.
          </p>

          <p>
            <strong>Cuida tu cuerpo.</strong> El duelo tiene una dimensión física real: puede afectar el sueño, el apetito, la energía, el sistema inmune. Comer bien, dormir lo que puedas, moverse aunque sea un poco, no son lujos: son parte del proceso de sanación.
          </p>
          ...
          <p>
            <strong>Sé paciente con los tiempos.</strong> No hay un plazo para superar un divorcio. Algunas personas sienten que se estabilizan en meses; otras necesitan años. Compararte con los tiempos de otras personas no ayuda. Tu proceso es tuyo.
          </p>

          <h2 className="text-2xl md:text-3xl text-black font-semibold mt-8 mb-4">Cuándo buscar acompañamiento profesional</h2>
          ...
          <ul className="list-disc ml-6 space-y-2">
            <li>Cuando los síntomas de tristeza o ansiedad son intensos y duraderos (más de varias semanas sin mejoría).</li>
            <li>Cuando el duelo está afectando significativamente tu trabajo, tus relaciones o tu vida diaria.</li>
            <li>Cuando tienes pensamientos de hacerte daño.</li>
            <li>Cuando sientes que el enojo o la amargura están tomando el control.</li>
            <li>Cuando hay hijos involucrados y necesitas apoyo para acompañarlos en su propio proceso.</li>
            <li>Cuando sientes que el proceso está "atascado" y no avanza a pesar del tiempo.</li>
          </ul>
          ...
          <p>
            <strong>¿Es normal seguir amando a mi ex y aun así saber que el divorcio era lo correcto?</strong><br />
          ...
          <p>
            <strong>¿Por cuánto tiempo es "normal" estar de duelo por un divorcio?</strong><br />
          ...
          <p>
            <strong>¿Cómo acompaño a mis hijos en el duelo por el divorcio?</strong><br />
          ...
          <p>
            <strong>¿Es posible hacer el duelo si el divorcio fue hace muchos años pero nunca lo procesé?</strong><br />
        ...
        <div className="mt-16 p-8 bg-[#B2F7EF]/10 rounded-2xl border border-[#B2F7EF] text-center">
          <h3 className="text-2xl text-black mb-4 font-semibold">No tienes que atravesar esto sola</h3>
