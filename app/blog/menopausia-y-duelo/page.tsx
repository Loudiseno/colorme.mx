    ...
    <article className="pt-28 pb-6 md:pt-32 md:pb-8">
      <div className="max-w-3xl mx-auto px-6">
        ...
        <div className="mb-12 rounded-2xl overflow-hidden">
          <Image src="/menopausia-yduelo.jpeg" alt="Menopausia y duelo" width={300} height={200} className="w-full h-auto" />
        </div>
        ...
        <div className="prose prose-lg max-w-none text-black/80">
          ...
          <h2 className="text-2xl md:text-3xl text-black font-semibold mt-8 mb-4">La arteterapia en este tránsito</h2>
        ...
        <div className="mt-16 p-8 bg-[#B2F7EF]/10 rounded-2xl border border-[#B2F7EF] text-center">
          ...
          <p className="text-black/70 mb-6 max-w-xl mx-auto">
            Si estás atravesando la menopausia y sientes que hay algo más que síntomas físicos, que hay un duelo que necesita espacio, estoy aquí para acompañarte con tanatología y arteterapia.
          </p>
