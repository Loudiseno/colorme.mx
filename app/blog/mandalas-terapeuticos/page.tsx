    ...
    <article className="pt-28 pb-6 md:pt-32 md:pb-8">
      <div className="max-w-3xl mx-auto px-6">
        ...
        <div className="prose prose-lg max-w-none text-black/80">
          ...
          <p>
            <strong>3. Divide el espacio.</strong> Puedes dividir el círculo en 4, 6, 8 o más secciones. Esto crea una referencia para tus patrones, pero no es obligatorio.
          </p>
        ...
        <div className="mt-16 p-8 bg-[#B2F7EF]/10 rounded-2xl border border-[#B2F7EF] text-center">
          ...
          <p className="text-black/70 mb-6 max-w-xl mx-auto">
            Si quieres descubrir el poder terapéutico de los mandalas, estoy aquí para acompañarte en el proceso.
          </p>
          <a
        ...
        {/* Related Articles */}
        <RelatedArticles currentSlug="mandalas-terapeuticos" category="arteterapia" />
      </div>
    </article>
  )
}
