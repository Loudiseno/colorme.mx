    ...
    <article className="pt-28 pb-16 md:pt-36 md:pb-20">
      <div className="max-w-3xl mx-auto px-6">
        ...
        <div className="prose prose-lg max-w-none text-black/80">
          ...
          <ul>
            <li><strong>Experiencias tempranas de abandono.</strong> Si durante la infancia experimentaste ausencia emocional o fisica de figuras de cuidado, es probable que cargaras la sensacion de que las personas importantes se van. Ese miedo puede persistir en la vida adulta aunque las circunstancias hayan cambiado.</li>
            <li><strong>Perdidas significativas.</strong> La muerte de alguien cercano, el fin de una relacion importante, cualquier perdida que te haya dejado sintiendote solo puede activar el miedo de que vuelva a suceder.</li>
            <li><strong>Mensajes culturales.</strong> Vivimos en una cultura que presenta la soledad como fracaso. El valor de una persona parece medirse por sus relaciones. No tener pareja, no tener muchos amigos, pasar tiempo solo se interpreta como senal de que algo esta mal contigo.</li>
            <li><strong>Falta de relacion contigo mismo.</strong> Para muchas personas, la idea de estar a solas consigo mismas es aterradora porque no saben como estar con ellas mismas. Nunca aprendieron. Siempre hubo distracciones, otras personas, ruido que llenaba el vacio.</li>
          </ul>
          ...
          <ul>
            <li><strong>Relaciones que no queremos.</strong> Quedarse en relaciones que ya no funcionan, que son daninas, o que simplemente no deseas, solo por no estar solo. El costo de esta decision se paga en bienestar, en autenticidad, en tiempo de vida.</li>
            <li><strong>Tolerar lo intolerable.</strong> Aceptar maltratos, faltas de respeto, condiciones que no aceptarias si no tuvieras tanto miedo de quedarte sin nadie. El miedo a la soledad puede mantenerte atrapado en situaciones que te destruyen.</li>
            <li><strong>Nunca estar contigo mismo.</strong> Llenar cada momento con compania, con ruido, con actividad. No soportar el silencio. No poder estar en tu propia presencia sin sentir urgencia de escapar.</li>
            <li><strong>Dependencia emocional.</strong> Necesitar a otra persona para sentirte completo, para regular tus emociones, para saber quien eres. Cuando esa persona no esta disponible, el panico aparece.</li>
            <li><strong>Complacer compulsivamente.</strong> Decir que si a todo, adaptarte a lo que otros quieren, perderte a ti mismo con tal de que te acepten. Si dices que no, si eres autentico, quizas te rechacen. Y el rechazo es el camino a la soledad.</li>
          </ul>
          ...
          <ul>
            ...
            <li><strong>Observa que aparece.</strong> Cuando estas solo y sin distracciones, que pensamientos y emociones surgen? Esa informacion es valiosa. Te dice que hay dentro de ti que normalmente evitas.</li>
            <li><strong>Encuentra actividades que disfrutes solo.</strong> Leer, caminar, crear arte, cocinar, lo que sea que te de satisfaccion sin necesitar compania. Desarrollar una relacion con tu propia compania.</li>
            <li><strong>Cuestiona los mensajes culturales.</strong> Estar solo no significa que nadie te quiera. Puede significar que te valoras lo suficiente como para elegir bien con quien pasas tu tiempo. Puede significar independencia, no fracaso.</li>
          </ul>
