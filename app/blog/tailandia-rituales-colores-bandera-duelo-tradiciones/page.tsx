    ...
    <article className="pt-28 pb-16 md:pt-36 md:pb-20">
      <div className="max-w-3xl mx-auto px-6">
        ...
        <div className="prose prose-lg max-w-none text-black/80">
          ...
          <h2 className="text-2xl md:text-3xl text-black font-semibold mt-8 mb-4">La magia del amanecer tailandés</h2>
        ...
        <RelatedArticles currentSlug="tailandia-rituales-colores-bandera-duelo-tradiciones" category="rituales" />
      </div>
    </article>
  )
}
