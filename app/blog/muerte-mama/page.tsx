    ...
    <article className="pt-28 pb-6 md:pt-32 md:pb-8">
      <div className="max-w-3xl mx-auto px-6">
        ...
        <div className="prose prose-lg max-w-none text-black/80">
          ...
          <p>
            Este espacio no te va a decir cómo &quot;superar&quot; su muerte, porque eso implica dejarla atrás. Lo que voy a ofrecerte es algo más realista: cómo aprender a vivir con su ausencia. Cómo cargar ese amor que ahora no tiene el mismo destino. Cómo seguir adelante sin olvidarla.
          </p>
