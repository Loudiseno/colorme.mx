        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-12 gap-x-14 gap-y-16">
            ...
            <div className="md:col-span-5">
              <div className="md:sticky md:top-28">
                <div className="flex items-baseline gap-3 mb-2">
                  <span className="text-sm text-[#0D9488] tabular-nums">
                    {String(exposicionesIndividuales.length).padStart(2, '0')}
                  </span>
                  <h3 className="text-2xl md:text-3xl text-black">Individuales</h3>
                </div>
            ...
            <div className="md:col-span-7">
              <div className="flex items-baseline gap-3 mb-2">
                <span className="text-sm text-[#0D9488] tabular-nums">
                  {String(exposicionesColectivas.length).padStart(2, '0')}
                </span>
                <h3 className="text-2xl md:text-3xl text-black">Colectivas</h3>
              </div>
