...
export const metadata: Metadata = {
  ...
  description: 'Conoce a Lou, arteterapeuta, tanatóloga, diseñadora, artista y sobreviviente de cáncer. Formación en México, Bali, Tailandia, Malasia, India y Reino Unido.',
