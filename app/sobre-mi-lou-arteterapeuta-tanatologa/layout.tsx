...
export const metadata: Metadata = {
  ...
  description: 'Conoce a Lou, tanatóloga y facilitadora de arte como terapia, diseñadora, artista y sobreviviente de cáncer. Formación en México, Bali, Tailandia, Malasia, India y Reino Unido.',
