...
export const metadata: Metadata = {
  ...
  description:
    'Emotional support through art as therapy and grief counseling — to heal grief, move through change, and work with your emotions. First session free.',
  ...
  openGraph: {
    ...
    description:
      'Emotional support through art as therapy and grief counseling. First session free.',
    url: '/en',
  },
  ...
  return (
    <div lang="en">
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-stretch">
            <div className="flex flex-col justify-center">
              ...
              <div className="space-y-4 text-black/70 leading-relaxed mb-8">
                <p>
                  ColorMe is a space for professional accompaniment through grief, loss,
                ...
                <div className="flex flex-col h-full">
                  ...
                  <div className="flex-1">
                    <div className="inline-block bg-[#B2F7EF] px-6 py-2 rounded-xl mb-4 relative">
                      ...
                      <h2 className="text-2xl md:text-3xl text-black relative z-10">Hi, I&apos;m Lou</h2>
                    </div>
                    <p className="text-black font-bold mb-4">
                      Art as therapy practitioner, grief counselor, designer, artist, and cancer
                      survivor.
                    </p>
                    <p className="text-black/70 leading-relaxed">
                      Creativity has always been my way of connecting with the world. My own losses
                      led me to accompany others through their processes of change and
                      transformation — through listening, through art, or through both. My training
                      integrates techniques from Mexico, Bali, Thailand, Malaysia, and India.
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-white rounded-2xl p-8 border border-[#B2F7EF] flex flex-col items-center text-center">
              ...
              <p className="text-black/70 leading-relaxed mb-6">
                Emotional accompaniment through art to express, understand, and transform emotions —
                with no aesthetic goals and no artistic experience required.
              </p>
              <Link
            ...
            <div className="bg-white rounded-2xl p-8 border border-[#B2F7EF] flex flex-col items-center text-center">
              ...
              <p className="text-black/70 leading-relaxed mb-6">
                Accompaniment through grief and loss in a safe space to express emotions, move
                through the pain, and give new meaning to what you have lived.
              </p>
              <Link
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              <div className="w-32 h-32 mx-auto mb-4 relative">
                <Image src="/columpio.webp" alt="Individual therapy" width={128} height={128} className="object-contain" />
              </div>
              <h3 className="text-xl md:text-2xl text-black mb-3 font-semibold">Individual sessions</h3>
              <p className="text-black/70 leading-relaxed">
                Personalised sessions at your own pace and to your needs, with close emotional
                support.
              </p>
            </div>
            <div className="text-center">
              ...
              <p className="text-black/70 leading-relaxed">
                Safe gatherings to create, share, and heal collectively, working on themes of common
                interest.
              </p>
            </div>
            <div className="text-center">
              <div className="w-32 h-32 mx-auto mb-4 relative">
                <Image src="/adolecente-hombre.webp" alt="Workshops for organisations" width={128} height={128} className="object-contain" />
              </div>
              <h3 className="text-xl md:text-2xl text-black mb-3 font-semibold">Workshops for organisations</h3>
              <p className="text-black/70 leading-relaxed">
                Emotional wellbeing programmes designed around each group&apos;s objectives.
              </p>
            </div>
          </div>
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 gap-8 items-stretch">
            <div className="bg-[#B2F7EF]/10 rounded-3xl border border-[#B2F7EF] p-8 flex flex-col">
              ...
              <h3 className="text-3xl md:text-4xl text-black mb-2 text-center">
            ...
            <div className="bg-[#B2F7EF]/10 rounded-3xl border border-[#B2F7EF] p-8 flex flex-col">
              <div className="max-w-[220px] mx-auto mb-6 rounded-2xl overflow-hidden shadow-lg">
                <Image
                  ...
                  alt="The Art of Inhabiting Your Grief — a guided grief journal by Lou"
                  width={900}
                  height={1165}
                  className="w-full h-auto"
                />
              ...
              <ul className="space-y-2 mb-6 flex-1">
                <li className="flex items-start gap-2 text-black/70 text-sm leading-snug">
                  <span className="text-[#B2F7EF] mt-0.5 font-bold">✓</span>
                  A guide in four movements: recognising what you lost, making room for your
                  emotions, reorganising your life, and integrating it into your story.
                </li>
                <li className="flex items-start gap-2 text-black/70 text-sm leading-snug">
                  <span className="text-[#B2F7EF] mt-0.5 font-bold">✓</span>
                  Over 50 art, writing, and reflection exercises across 189 pages
                </li>
                <li className="flex items-start gap-2 text-black/70 text-sm leading-snug">
                  <span className="text-[#B2F7EF] mt-0.5 font-bold">✓</span>
      ...
      <section className="py-10 md:py-12 bg-[#B2F7EF]/5">
        <div className="max-w-3xl mx-auto px-6 text-center">
          <h2 className="text-4xl md:text-5xl text-black mb-4">Between the Lines</h2>
      ...
      <section className="py-10 md:py-12 bg-[#B2F7EF]/5" id="contact">
        <div className="max-w-3xl mx-auto px-6 text-center">
          ...
          <p className="text-black/70 mb-8">
            The first session is free. Tell me a little about yourself and what you&apos;re looking
            for.
          </p>
      ...
      <section className="py-10 md:py-12 bg-white">
        <div className="max-w-3xl mx-auto px-6 text-center">
          ...
          <p className="text-black/60 mb-6">Support, art, and reflections for your everyday.</p>
