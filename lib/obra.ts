...
export const lugares: ObraPhoto[] = [
  ...
  { src: '/lugares-malta.jpeg', alt: 'Malta — fotografía de Lou', caption: 'Malta', captionEn: 'Malta', country: 'Malta', countryEn: 'Malta' },
  ...
  { src: '/lugares-la-puerta-azul-malta.jpeg', alt: 'Malta — fotografía de Lou', caption: 'Malta', captionEn: 'Malta', country: 'Malta', countryEn: 'Malta' },
  ...
  { src: '/lugares-atardecer-trinidad.jpeg', alt: 'Trinidad, Cuba — fotografía de Lou', caption: 'Trinidad, Cuba', captionEn: 'Trinidad, Cuba', country: 'Cuba', countryEn: 'Cuba' },
  { src: '/lugares-baja-california.jpeg', alt: 'Baja California, México — fotografía de Lou', caption: 'Baja California, México', captionEn: 'Baja California, Mexico', country: 'México', countryEn: 'Mexico' },
  { src: '/lugares-cisterna-basilica-estambul.jpeg', alt: 'Estambul, Turquía — fotografía de Lou', caption: 'Estambul, Turquía', captionEn: 'Istanbul, Turkey', country: 'Turquía', countryEn: 'Turkey' },
  { src: '/lugares-capadocia.jpeg', alt: 'Capadocia, Turquía — fotografía de Lou', caption: 'Capadocia, Turquía', captionEn: 'Cappadocia, Turkey', country: 'Turquía', countryEn: 'Turkey' },
  { src: '/lugares-meteora.jpeg', alt: 'Meteora, Grecia — fotografía de Lou', caption: 'Meteora, Grecia', captionEn: 'Meteora, Greece', country: 'Grecia', countryEn: 'Greece' },
  { src: '/lugares-moulin-rouge-amsterdam.jpeg', alt: 'Ámsterdam, Países Bajos — fotografía de Lou', caption: 'Ámsterdam, Países Bajos', captionEn: 'Amsterdam, Netherlands', country: 'Países Bajos', countryEn: 'Netherlands' },
  { src: '/lugares-reflejos-amsterdam.jpeg', alt: 'Ámsterdam, Países Bajos — fotografía de Lou', caption: 'Ámsterdam, Países Bajos', captionEn: 'Amsterdam, Netherlands', country: 'Países Bajos', countryEn: 'Netherlands' },
  { src: '/lugares-colonia.jpeg', alt: 'Colonia, Alemania — fotografía de Lou', caption: 'Colonia, Alemania', captionEn: 'Cologne, Germany', country: 'Alemania', countryEn: 'Germany' },
  ...
  { src: '/lugares-vietnam.jpeg', alt: 'Vietnam — fotografía de Lou', caption: 'Vietnam', captionEn: 'Vietnam', country: 'Vietnam', countryEn: 'Vietnam' },
  { src: '/lugares-tailandia.jpeg', alt: 'Tailandia — fotografía de Lou', caption: 'Tailandia', captionEn: 'Thailand', country: 'Tailandia', countryEn: 'Thailand' },
  ...
  { src: '/lugares-capadocia-1.jpeg', alt: 'Capadocia, Turquía — fotografía de Lou', caption: 'Capadocia, Turquía', captionEn: 'Cappadocia, Turkey', country: 'Turquía', countryEn: 'Turkey' },
...
export const gente: ObraPhoto[] = [
  { src: '/gente-smile-bali.jpeg', alt: 'Bali, Indonesia — fotografía de Lou', caption: 'Bali, Indonesia', captionEn: 'Bali, Indonesia', country: 'Indonesia', countryEn: 'Indonesia' },
  { src: '/gente-ceremonia-bali.jpeg', alt: 'Bali, Indonesia — fotografía de Lou', caption: 'Bali, Indonesia', captionEn: 'Bali, Indonesia', country: 'Indonesia', countryEn: 'Indonesia' },
  ...
  { src: '/gente-tailandia-8.jpeg', alt: 'Tailandia — fotografía de Lou', caption: 'Tailandia', captionEn: 'Thailand', country: 'Tailandia', countryEn: 'Thailand' },
  { src: '/gente-vietnam-9.jpeg', alt: 'Vietnam — fotografía de Lou', caption: 'Vietnam', captionEn: 'Vietnam', country: 'Vietnam', countryEn: 'Vietnam' },
]
