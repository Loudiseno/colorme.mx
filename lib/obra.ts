...
export const lugares: ObraPhoto[] = [
  ...
  { src: '/fotografia-lugar-la-habana-cuba-2.jpeg', alt: 'Fotografía de La Habana, Cuba, por Lourdes Pérez', caption: 'La Habana, Cuba', captionEn: 'Havana, Cuba', country: 'Cuba', countryEn: 'Cuba' },
  { src: '/fotografia-lugar-selime-turquia.jpeg', alt: 'Fotografía de Selime, Turquía, por Lourdes Pérez', caption: 'Selime, Turquía', captionEn: 'Selime, Turkey', country: 'Turquía', countryEn: 'Turkey' },
  ...
  { src: '/fotografia-lugar-mykonos-grecia.jpeg', alt: 'Fotografía de Mykonos, Grecia, por Lourdes Pérez', caption: 'Mykonos, Grecia', captionEn: 'Mykonos, Greece', country: 'Grecia', countryEn: 'Greece' },
  ...
  { src: '/fotografia-lugar-wat-pho-tailandia.jpeg', alt: 'Fotografía de Wat Pho, Tailandia, por Lourdes Pérez', caption: 'Wat Pho, Tailandia', captionEn: 'Wat Pho, Thailand', country: 'Tailandia', countryEn: 'Thailand' },
  { src: '/fotografia-lugar-bangkok-tailandia-7.jpeg', alt: 'Fotografía de Bangkok, Tailandia, por Lourdes Pérez', caption: 'Bangkok, Tailandia', captionEn: 'Bangkok, Thailand', country: 'Tailandia', countryEn: 'Thailand' },
...
export const mixtas: ObraPiece[] = [
  ...
  },
  {
    ...
    caption: 'Manchester Bee\nTécnica mixta sobre mapa original de la Ordnance Survey (Reino Unido)\n65 × 76 cm',
    captionEn: 'Manchester Bee\nMixed media on an original Ordnance Survey map (United Kingdom)\n65 × 76 cm',
  },
  {
